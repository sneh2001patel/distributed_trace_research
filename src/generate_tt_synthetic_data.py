...
def main():
        ...
        jobs.append(
            {
                ...
                "out_path": args.normal_out_path or "./datasets/anomaly/TT/TT_normal_synthetic.pt",
                "y_label": 0,
            }
        )
        ...
        jobs.append(
            {
                ...
                "out_path": args.abnormal_out_path or "./datasets/anomaly/TT/TT_abnormal_synthetic.pt",
                "y_label": 1,
            }
        )
    ...
    summary_path = Path(args.summary_path) if args.summary_path else ROOT / "datasets" / "anomaly" / "TT" / "synthetic_summary.json"
