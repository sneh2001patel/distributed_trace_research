...
class LoadDataset(InMemoryDataset):
    ...
    def __init__(self, datapath="../datasets/variable_size/SN_synthetic.pt") -> None:
...
def main(
    real_path="../datasets/SN_data.pt",
    synth_path="../datasets/variable_size/SN_synthetic.pt",
):
...
main(
    real_path="../datasets/SN_data.pt",
    synth_path="../datasets/fixed_size/prop_order_SN_synthetic.pt",
)
main(
    real_path="../datasets/TT_data.pt",
    synth_path="../datasets/fixed_size/prop_order_TT_synthetic.pt",
)
