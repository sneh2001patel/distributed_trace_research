...
class LoadDataset(InMemoryDataset):
    def __init__(self, datapath="./datasets/anomaly/TT/TT_abnormal.pt") -> None:
...
def main(
    ...
    datapath = "./datasets/anomaly/TT/TT_abnormal.pt"
    ...
    print(
        f"Using {len(sampled_graphs)} sampled TT abnormal graphs with <= {max_nodes} nodes "
