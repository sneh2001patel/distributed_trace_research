...
class LoadDataset(InMemoryDataset):
    def __init__(self, datapath="./datasets/anomaly/SN/SN_abnormal.pt") -> None:
...
def main():
    ...
    if not filtered_graphs:
        raise RuntimeError("All SN abnormal graphs were filtered out.")
    ...
    print(
        f"Using {len(sampled_graphs)} sampled SN abnormal graphs with <= {max_nodes} nodes "
